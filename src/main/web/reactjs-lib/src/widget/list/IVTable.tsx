...
export const PAGE_SIZES = [10, 50, 500, 5000, 50000, 100000];
...
export interface VTableFilterConfig {
  name: string, label?: string, icon?: string, hint?: string, active?: boolean,
  createComponent: (table: IVTable) => any,
}

export interface VTableColumnConfig {
  name: string, label: string, visible?: boolean, width?: number,
  actions?: Array<
    {
      name: string, label?: string, icon?: string, hint?: string,
...
export interface VTableCommonProps {
  className?: string, style?: any, config: VTableConfig, model: ListModel
}
