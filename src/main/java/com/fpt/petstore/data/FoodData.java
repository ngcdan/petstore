...
public class FoodData {
	...
	public Food food_1 =new Food("Bánh thưởng cho chó dạng que vị việt quất WUJI Jerky Stick Blueberry Flavor", 55000).
	...
	public Food food_9 = new Food("Bánh thưởng cho mèo vị cá hồi JERHIGH Jinny Salmon", 35000).
	  ...
	  public Food food_10 = new
	  Food("Bánh thưởng cho chó vị cá hồi VEGEBRAND 7 Dental Benefits Salmon Block Stick", 125000)
	  .withType(Food.FoodType.SNACK)
	  .withSortName("banh-thuong-cho-cho-vi-ca-hoi")
	  .withDescription("Bánh thưởng cho chó vị cá hồi VEGEBRAND 7 Dental Benefits Salmon Block Stick hỗ trợ vấn đề răng miệng rất tốt cho thú cưng.\r\n" + 
	...
	public Food food_17 = new Food("Bánh thưởng cho chó vị thịt gà dạng que VEGEBRAND Orgo Dental Chew Chicken Flavor", 50000).	
			withType(Food.FoodType.SNACK).
	...
	public Food food_20 = new Food(" Bánh thưởng cho chó dạng hạt VEGEBRAND Orgo Endi Chew Chicken Flavor ", 50000).	
			withType(Food.FoodType.SNACK).
	...
	public Food food_21 = new Food(" Xương Canxi cho chó VEGEBRAND Orgo Calcium Bone ", 65000).	
			withType(Food.FoodType.DRY).
			withSortName("xuong-canxi-cho-cho").
		withDescription(" Xương Canxi cho chó VEGEBRAND Orgo Calcium Bone chứa hàm lượng Canxi cao. Đảm bảo xương luôn chắc khỏe\r\n" + 
	...
	public Food food_22 = new Food(" Xương gặm sạch răng cho chó vị phô mai VEGEBRAND 7 Dental Effects Cheese Dental Bone ", 60000).	
			withType(Food.FoodType.DRY).
			withSortName("xuong-gam-sach-rang-cho-cho-vi-pho-mai").
		withDescription("Xương gặm sạch răng cho chó vị phô mai VEGEBRAND 7 Dental Effects Cheese Dental Bone với thành phần từ thiên nhiên, không chứa chất bảo quản\r\n" + 
	...
	public Food food_23 = new Food(" Thức ăn cho chó con JOSERA Young Star ", 100000).	
			withType(Food.FoodType.DRY).
			withSortName("thuc-an-cho-cho-con").
		withDescription(" Dễ tiêu hóa mà không có ngũ cốc.\r\n" + 
	...
	public Food food_24 = new Food("  Thức ăn cho chó trưởng thành cỡ nhỏ EARTHBORN HOLISTIC Small Breed", 595000).	
			withType(Food.FoodType.DRY).
			withSortName("thuc-an-cho-cho-truong-thanh-co-nho").
		withDescription(" Các nguồn protein cao cấp, chẳng hạn như bột thịt gà và bột cá trắng, hỗ trợ xây dựng và duy trì khối lượng cơ nạc của chú chó.\r\n" + 
	...
	public Food food_25 = new Food(" Thức ăn cho chó trưởng thành JOSERA Mini Deluxe 15kg ", 200000).	
			withType(Food.FoodType.DRY).
			withSortName("thuc-an-cho-cho-truong-thanh").
		withDescription("Thịt cừu non thay vì thịt gia cầm.\r\n" + 
	...
	public Food food_26 = new Food(" Xương gặm sạch răng cho chó vị thịt bò VEGEBRAND 7 Dental Effects Roast Beef Stick ", 95000).	
			withType(Food.FoodType.DRY).
			withSortName("xuong-gam-sach-rang-cho-cho-vi-thit-bo").
		withDescription(" Sản phẩm với thành phần từ thiên nhiên, không chứa chất bảo quản giúp cho hương vị trở nên thơm ngon, bổ dưỡng\r\n" + 
				"Xương dinh dưỡng cho chó giúp làm sạch răng, loại bỏ 99% những mảng cao răng cứng đầu\r\n" + 
	...
	public Food food_27 = new Food(" Thức ăn cho chó vị thịt vịt ANF Organic 6 Free Duck ", 95000).	
			withType(Food.FoodType.DRY).
			withSortName("thuc-an-cho-cho-vi-thit-vit").
		withDescription(" Thức ăn cho chó vị thịt vịt ANF Organic 6 Free Duck bao gồm Thịt vịt là nguồn protein cao cấp tuyệt vời chứa các axit amin thiết yếu cân bằng\r\n" + 
	...
	public Food food_28 = new Food(" Xương cho chó gặm vị cá hồi VEGEBRAND Meat Salmon Bone Small ", 60000).	
			withType(Food.FoodType.DRY).
			withSortName("xuong-cho-cho-gam-vi-ca-hoi").
		withDescription(" Xương cho chó gặm vị cá hồi VEGEBRAND Meat Salmon Bone Small với thành phần từ tự nhiên không chất bảo quản.\r\n" + 
	...
	public Food food_29 = new Food(" Thức ăn cho chó con PRO PAC ULTIMATES Puppy Chicken & Brown Rice Formula ", 445000).	
			withType(Food.FoodType.DRY).
			withSortName("thuc-an-cho-cho-con-pro-pac-ultimates").
		withDescription(" PRO PAC ULTIMATES Puppy Chicken & Brown Rice Formula cung cấp dinh dưỡng hoàn chỉnh và một chế độ ăn uống cân bằng cho chó con\r\n" + 
	...
	public Food food_30 = new Food(" Pate cho chó vị bò và rau IRIS HRBV375 Beef & Vegetable ", 85000).	
			withType(Food.FoodType.WET).
			withSortName("pate-cho-cho-vi-bo-va-rau").
		withDescription(" Pate cho chó vị bò và rau IRIS HRBV375 Beef & Vegetable bao gồm: gà, bò, cà rốt thái sợi, đậu nành xanh… Cung cấp đầy đủ dưỡng chất cho thú cưng trong mỗi bữa ăn. ")
		.withPic("food29.jpg");
	
	public Food food_31 = new Food(" Thức ăn cho chó con ROYAL CANIN Shiba Inu Junior ", 90000).	
			withType(Food.FoodType.DRY).
			withSortName("thuc-an-cho-cho-con-shiba").
		withDescription(" Thức ăn cho chó ROYAL CANIN Shiba Inu Junior với công thức đặc chế riêng cho nhu cầu dinh dưỡng của chó Shiba. Sản phẩm được chế biến theo công thức đề cao hệ miễn dịch, giúp da lông chắc khỏe. Bảo vệ da và lông. EPA/DHA: có tác dụng giúp da và lông phát triển khỏe mạnh. Tăng sức đề kháng. Chất chống oxy hóa CELT: hỗ trợ hệ miễn dịch của chó. ")
		.withPic("food30.jpg");
	
	public Food food_32 = new Food(" Sữa bột cho chó BBN Goat’s Milk New Zealand ", 320000).	
			withType(Food.FoodType.MILK).
			withSortName("sua-bot-cho-cho").
		withDescription(" Sản phẩm sữa bột cho chó BBN Goat’s Milk New Zealand được chế biến sản xuất từ sữa dê thô đặc biệt tại New Zealand trên dây chuyền công nghệ cao.\r\n" + 
	...
	public Food food_33 = new Food(" Bánh thưởng cho chó vị thịt bò BUDGE Beef Flavor ", 60000).	
			withType(Food.FoodType.SNACK).
			withSortName("banh-thuong-cho-cho-vi-thit-bo").
		withDescription(" Bánh thưởng cho chó vị thịt bò BUDGE Beef Flavor bổ sung vitamin và khoáng chất thiết yếu cho cún cưng. Xương dinh dưỡng cho chó giúp làm sạch răng, loại bỏ 99% những mảng cao răng cứng đầu. Hơn nữa sản phẩm còn thúc đẩy hệ tiêu hóa, tránh những bệnh về đường ruột. Làm giảm mùi hôi miệng cho thú cưng. ")
		.withPic("food32.jpg");
	
	public Food food_34 = new Food(" Pate cho chó vị thịt và rau củ IRIS Chicken Beef & Vegetable ", 35000).	
			withType(Food.FoodType.WET).
	...
	public Food food_35 = new Food(" Thức ăn cho chó MEC Wild Taste Nutrition for Poodle ", 265000).	
			withType(Food.FoodType.DRY).
			withSortName("thuc-an-cho-cho-mec-wild").
		withDescription(" Thức ăn cho chó MEC Wild Taste Nutrition for Poodle được chế biến từ nguyên liệu hoàn toàn tự nhiên\r\n" + 
	...
	public Food food_36 = new Food(" Pate cho chó vị thịt bò và mề gà IRIS Beef & Chicken Gizzard ", 60000).	
			withType(Food.FoodType.WET).
	...
	public Food food_37 = new Food(" Pate cho chó vị cá IRIS One Care Fish ", 35000).	
			withType(Food.FoodType.WET).
	...
	public Food food_38 = new Food(" Pate cho chó trưởng thành ROYAL CANIN Chihuahua Adult ", 55000).	
			withType(Food.FoodType.WET).
			withSortName("pate-cho-cho-truong-thanh").
		withDescription(" Được chế biến đặc biệt với tất cả các nhu cầu dinh dưỡng của chú chó trưởng thành của bạn\r\n" + 
	...
	public Food food_39 = new Food(" Thức ăn cho chó trưởng thành JOSERA Josidog Agilo Sport ", 100000).	
			withType(Food.FoodType.DRY).
			withSortName("thuc-an-cho-cho-truong-thanh-josera-josidog").
		withDescription( " Preulinotic inulin thúc đẩy hệ đường ruột\r\n" + 
	...
	public Food food_40 = new Food(" Que bánh thưởng cho chó BOWWOW Stick Jerky Lamd ", 40000).	
			withType(Food.FoodType.SNACK).
			withSortName("que-banh-thuong-cho-cho").
		withDescription(" Thành phần tươi sạch, thích hợp với mọi giống chó, lứa tuổi, cân nặng\r\n" + 
	...
	public Food[] ALL_FOODS = {food_1, food_2, food_3, food_4, food_5, food_6, food_7, food_8, food_9,food_10,
