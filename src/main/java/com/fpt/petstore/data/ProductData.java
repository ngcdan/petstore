...
public class ProductData {
	...
	public Product   product_9    =
			...
			withPrice(90000).
			withDescription("Bát ăn inox cho chó mèo có vỏ được làm từ chất liệu nhựa cao cấp không gây hại.").
			withPic("product9.jpg");
	
	public Product   product_10    =
			new Product("Bình uống nước cho Chó/Mèo đi dạo").
			withProductType(Product.ProductType.DOG).
			withSortName("Bình uống nước").
			withPrice(90000).
			withDescription("Bình uống nước cho chó mèo đi dạo không thể thiếu dành cho thú cưng hay đi offline, đi dạo và hoạt động thể lực thường xuyên.").
	...
	public Product   product_11    =
			...
			withPrice(150000).
			withDescription("Đồ chơi cho chó mèo bằng bông chút chít không gây độc hại cho thú cưng.\r\n").
			withPic("product11.jpg");
	
	public Product   product_12    =
			new Product("Đồ chơi cho chó bằng cao su SOLEIL hình xương").
			withProductType(Product.ProductType.DOG).
			withSortName("Đồ chơi cao su").
			withPrice(150000).
			withDescription("Đồ chơi cho chó với chất liệu thừng kết hợp vòng cao su cao cấp tự nhiên, không gây độc hại cho chó. Có độ bền cao và khả năng đàn hồi tốt.").
			withPic("product12.jpg");
	
	public Product   product_13    =
			new Product("Đồ chơi chó nhồi bông IKEA Hoppig Bernese Mountain").
			withProductType(Product.ProductType.DOG).
			withSortName("Đồ chơi nhồi bông").
			withPrice(390000).
			withDescription("Đồ chơi chó nhồi bông IKEA Hoppig Bernese Mountain có nhiều hình dạng ngộ nghĩnh đáng yêu thu hút sự chú ý của những người bạn 4 chân.").
			withPic("product13.jpg");
		
	public Product   product_14    =
			new Product("Roi huấn luyện chó mèo PAW").
			withProductType(Product.ProductType.CAT).
			withSortName("Roi huấn luyện").
			withPrice(90000).
			withDescription("Roi huấn luyện chó mèo PAW được dùng để huấn luyện, hướng dẫn, đào tạo thú cưng. "
	...
	public Product   product_15    =
			...
			withProductType(Product.ProductType.CAT).
			withSortName("Lược chải lông").
			withPrice(130000).
			withDescription("Lược chải lông chó mèo có nút bấm phù hợp với tất cả các giống chó."
	...
	public Product   product_16    =
			...
			withProductType(Product.ProductType.DOG).
			withSortName("Tông đơ cạo lông").
			withPrice(999000).
			withDescription("Tông đơ cạo lông chó mèo JOYU PHC 950 sử dụng chức năng pin sạc điện kèm theo các phụ kiện. "
	...
	public Product   product_17    =
			...
			withProductType(Product.ProductType.CAT).
			withSortName("Máy mài móng").
			withPrice(340000).
			withDescription("Máy mài móng chó mèo – JOYU Pet Nail Grinder N8 thiết kế tiện dụng, bạn có thể cảm thấy tay cầm rất thoải mái và máy dễ vận hành. "
	...
	public Product   product_18    =
			...
			withProductType(Product.ProductType.DOG).
			withSortName("Máy sấy lông").
			withPrice(2300000).
			withDescription("Máy sấy lông chó mèo chuyên dụng với công suất 1600w màu tím theo tiêu chuẩn chính thức của Anh. "
	...
	public Product   product_19    =
			...
			withProductType(Product.ProductType.DOG).
			withSortName("Dây dắt").
			withPrice(200000).
			withDescription("Dây dắt cho chó mèo tự động DELE là sản phẩm được thiết kế tay cầm bằng nhựa cao cấp." + 
	...
	public Product   product_20    =
			...
			withProductType(Product.ProductType.DOG).
			withSortName("Rõ mõm").
			withPrice(90000).
			withDescription("Rọ mõm chó hình mỏ vịt PAW Aduck được sản xuất từ nhựa silic mềm, màu sắc đẹp. Không độc không có mùi lạ.").
			withPic("product20.jpg");
	
	public Product   product_21    =
			new Product("Lồng vận chuyển chó mèo IRIS").
			withProductType(Product.ProductType.CAT).
			withSortName("Lồng vận chuyển").
			withPrice(1020000).
			withDescription("Lồng vận chuyển chó mèo IRIS sản xuất theo tiêu chuẩn quốc tế. "
	...
	public Product   product_22    =
			...
			withProductType(Product.ProductType.DOG).
			withSortName("Chuồng sắt").
			withPrice(2220000).
			withDescription("Chuồng sắt cho chó mèo có mái IRIS được thiết kế thông minh, đảm bảo chắc chắn, an toàn cho thú cưng.").
			withPic("product22.jpg");
		
	public Product   product_23    =
			new Product("Chuồng gỗ cho chó mèo RICHELL").
			withProductType(Product.ProductType.DOG).
			withSortName("CHuồng gỗ").
			withPrice(2250000).
			withDescription("Chuồng gỗ cho chó mèo RICHELL RC03 với chất liệu khung gỗ tự nhiên, hàng rào thép sơn tĩnh điện, lót sàn nhựa ABS (màu đen).").
			withPic("product23.jpg");
	
	public Product   product_24    =
			new Product("Chuồng quây cho chó bằng nhựa nan mỏng AUPET").
			withProductType(Product.ProductType.DOG).
			withSortName("Chuồng quây").
			withPrice(1550000).
			withDescription("Chuồng quây cho chó bằng nhựa nan mỏng AUPET 161 được sản xuất bởi chất liệu nhựa cao cấp PP an toàn cho thú cưng, thân thiện với môi trường, không gây độc hại.").
			withPic("product24.jpg");
	
	public Product   product_25    =
			new Product("Trụ cào móng cho mèo màu đỏ đen").
			withProductType(Product.ProductType.CAT).
			withSortName("Trụ cào móng").
			withPrice(29000).
			withDescription("Trụ cào móng cho mèo màu đỏ đen được làm từ thừng sisal, sisal là loại vật liệu rất chắc, bền được làm thành dạng dây. ").
			withPic("product25.jpg");
		
	public Product   product_26    =
			new Product("Cát vệ sinh cho mèo siêu vón IRIS").
			withProductType(Product.ProductType.CAT).
			withSortName("Cát vệ sinh").
			withPrice(150000).
			withDescription("Cát vệ sinh cho mèo siêu vón IRIS với công dụng vón thành cục siêu nhanh.").
			withPic("product26.jpg");
	
	public Product   product_27    =
			new Product("Sữa tắm cho mèo BBN For Cats Shampoo").
			withProductType(Product.ProductType.CAT).
			withSortName("Sữa tắm").
			withPrice(150000).
			withDescription("Sữa tắm cho mèo BBN For Cats Shampoo với chiết xuất từ quả đào tươi, tạo nên mùi hương dễ chịu, thơm mát cả ngày hoạt động.").
			withPic("product27.jpg");
	
	public Product   product_28    =
			new Product("Bộ đồ chơi cho mèo bằng cói BOBO").
			withProductType(Product.ProductType.CAT).
			withSortName("Bộ đồ chơi bằng cói").
			withPrice(60000).
			withDescription("Bộ đồ chơi cho mèo bằng cói BOBO kích thước size S với chất liệu bằng cói tự nhiên rất an toàn và không gây độc hại. ").
			withPic("product28.jpg");
		
	public Product   product_29    =
			new Product("Đồ chơi cho chó mèo Paw hình con gà").
			withProductType(Product.ProductType.CAT).
			withSortName("Đồ chơi con gà").
			withPrice(50000).
			withDescription("Đồ chơi cho chó mèo Paw hình con gà có một tiếng kêu rất đặc biệt, họ nói tiếng kêu của sản phẩm nghe rất khổ sở nên họ đều gọi sản phẩm này là chú gà có tiếng kêu thảm thiết." + 
	...
	public Product   product_30    =
			...
			withProductType(Product.ProductType.CAT).
			withSortName("Chuồng mèo 3 tầng").
			withPrice(2900000).
			withDescription("Chuồng mèo 3 tầng bằng sắt cao cấp sàn kín AUPET có 2 kích cỡ cho bạn lựa chọn:" + 
	...
	public Product   product_31    =
			...
			withProductType(Product.ProductType.DOG).
			withSortName("Vòng cổ chống ve").
			withPrice(60000).
			withDescription("Vòng cổ chống ve chó BIOLINE Flea and Tick Collar For Dogs là sản phẩm ngăn ngừa và điều trị ve, bọ chét cho chó từ 8 tuần tuổi trở lên.").
			withPic("product31.jpg");
		
	public Product   product_32    =
			new Product("Thuốc nhỏ gáy trị ve chó Frontline Plus").
			withProductType(Product.ProductType.DOG).
			withSortName("Thuốc trị ve").
			withPrice(250000).
			withDescription("Đáp ứng tất cả nhu cầu đó của bạn, Thuốc nhỏ gáy trị ve chó Frontline Plus MERIAL 20 – 40kg sẽ giúp bạn thật an tâm khi thú cưng sạch rận bọ mà lại an toàn. ").
			withPic("product32.jpg");
	
	public Product   product_33    =
			new Product("Banh Bóng Rổ Mon Ami Toy Vinyl").
			withProductType(Product.ProductType.DOG).
			withSortName("Banh bóng rổ").
			withPrice(32000).
			withDescription("Thương hiệu Việt Nam." + 
	...
	public Product   product_34    =
			...
			withProductType(Product.ProductType.DOG).
			withSortName("Xương gai sạch răng").
			withPrice(39000).
			withDescription("Thương hiệu Việt Nam." + 
	...
	public Product   product_35    =
			...
			withProductType(Product.ProductType.CAT).
			withSortName("Đồ chơi rượt bắt").
			withPrice(484000).
	...
	public Product[] ALL_PRODUCTS = { product_1, product_2, product_3, product_4, product_5, product_6, product_7, product_8, product_9, product_10, product_11, product_12, product_13, product_14, product_15, product_16, product_17, product_18, product_19, product_20, product_21, product_22, product_23, product_24, product_25, product_26, product_27, product_28, product_29, product_30, product_31, product_32, product_33, product_34, product_35, product_36, product_37, product_38, product_39, product_40 };
}
