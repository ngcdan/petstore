...
public class PetStoreData {
	...
	public List<Customer> createDataCustomer() {
		List<Customer> customers = new ArrayList<>(); for(int i = 0; i < ALL_CUSTOMERS.length; i++) {
			Customer customer = ALL_CUSTOMERS[i]; customers.add(customer);
		} return customers;
	}
	...
	public static Food food_6 = new Food("Nước sốt pate cho mèo CIAO vị thịt gà, cá ngừ & cá ngần trắng IC-86C", 25000).
		withDes("Vitamin E & Selen giúp bảo vệ tổn thương do các gốc tự do gây ra (Chất chống oxy hóa), " + "protein giúp phát triển cơ bắp và sửa chữa các mô.").withType(FoodType.DRY).withPic("food5.jpg");
	public static Food food_7 = new Food("Thức ăn cho mèo tiêu hóa búi lông ROYAL CANIN Hairball Care", 110000).
		withDes("Thức ăn cho mèo kiểm soát búi lông ROYAL CANIN Hairball Care đặc trị cho mèo dễ bị tắc lông, viêm búi lông. Kiểm soát búi lông cho mèo giúp bổ sung chất xơ tự nhiên, giúp bài tiết búi lông qua đường tiêu hóa cho mèo. Trị bệnh búi lông cho mèo. Hạt mã đề hỗ trợ tiêu hóa cho mèo, phòng các bệnh về đường tiêu hóa., "
			...
			+ "kiểm soát búi lông cho mèo giúp bổ sung chất xơ tự nhiên, " + "giúp bài tiết búi lông qua đường tiêu hóa cho mèo, " + "trị bệnh búi lông cho mèo.").withType(FoodType.DRY).withPic("food6.jpg");
	public static Food food_8 = new Food("Pate cho mèo vị cá ngừ và gà IRIS Tuna & Chicken", 35000).
		withDes("Pate cho mèo vị cá ngừ và gà IRIS Tuna & Chicken cung cấp đầy đủ chất đạm, béo, vitamin B1 và khoáng chất, " + "cá ngừ bổ sung omega 3,6 hỗ trợ rất tốt cho da và lông của mèo cưng, " + "thịt gà cung cấp protein giúp mèo cưng duy trì nguồn năng lượng hoạt động mỗi ngày," + "ổn định huyết áp, bảo vệ gan và hệ thống tim mạch, " + "cá ngừ chứa ít chất béo nhưng lại nhiều protein, vì vậy đảm bảo cung cấp năng lượng cho cơ thể mèo cưng. Vừa giảm nguy cơ béo phì hiệu quả. ").withType(FoodType.DRY).withPic("food7.jpg");
	public static Food food_9 = new Food("Bánh thưởng cho mèo vị cá hồi JERHIGH Jinny Salmon", 35000).
		withDes("Bánh thưởng cho mèo vị cá hồi JERHIGH Jinny Salmon là món ăn được vô cùng yêu thích, " + "là một món ăn được làm từ thịt gà và cá hồi thật, " + "được chế biến với tiêu chuẩn chất lượng. Được đóng gói với Taurine, Vitamin E và dầu cá (Omega3,6)," + "taurine là axit amin cần thiết., " + "phân tích đảm bảo: Chất đạm 22% tối thiểu. Chất béo thô9% tối thiểu. Sợi thô tối đa 2%. Độ ẩm tối đa 20%.").withType(FoodType.DRY).withPic("food8.jpg");
	public static Food food_10 = new Food("Dầu xả cho chó dưỡng lông TRIXIE Naturol Spulung", 180000).
		withDes("Dầu xả cho chó dưỡng lông TRIXIE Naturol Spulung chiết xuất từ hạt Macadamia, " + "là loại hạt có nguồn gốc từ Châu Úc. Chứa khoảng 22% các axit omega-7 palmitoleic, " + "và hơn 20 loại vitamin được coi là thần dược trong chăm sóc da. Giúp dưỡng ẩm, làm mềm mượt lông, thân thiện với da của chó nhỏ lẫn chó có làn da nhạy cảm,"
	...
	public Order order_2 = new Order("order_2").
		withEmployee(employee_10).
		withState(Order.State.DUE).
		withCustomer(customer_4).
		addOrderItem(food_2).
